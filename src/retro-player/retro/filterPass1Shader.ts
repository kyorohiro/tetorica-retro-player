// Pass 1: palette quantization, dithering, toon shading, glow, edge boost.
// Renders source texture → FBO with no curvature (flat UV).
// Pass 2 reads this FBO and applies CRT effects.
export const FILTER_FRAGMENT_PASS1 = `#version 300 es
