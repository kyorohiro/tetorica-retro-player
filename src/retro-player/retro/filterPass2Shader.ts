// Pass 2: CRT effects (curvature, scanlines, phosphor dots, vignette, tone compression).
// Reads Pass 1 FBO (palette-quantized output) via uPass1Texture.
// Neighbor sampling for phosphor dots reads directly from the FBO texture — no
// re-running the palette pipeline per neighbor.
export const FILTER_FRAGMENT_PASS2 = `#version 300 es
