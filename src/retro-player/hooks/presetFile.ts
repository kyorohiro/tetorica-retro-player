...
const DEFAULT_FILTER_SETTINGS: PersistedRetroFilterSettings = {
  ...
  grainVisibilityMode: DEFAULT_PRESET.grainVisibilityMode ?? "all",
  ...
  preFilterDownscaleEnabled: DEFAULT_PRESET.preFilterDownscaleEnabled ?? false,
  ...
  wideGlowEnabled: DEFAULT_PRESET.wideGlowEnabled ?? false,
  wideGlowMode: DEFAULT_PRESET.wideGlowMode ?? "optical",
