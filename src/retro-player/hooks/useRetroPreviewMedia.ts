...
type UseRetroPreviewMediaParams = {
  ...
  appRef: MutableRefObject<any>;
  spriteRef: MutableRefObject<Sprite | null>;
  textureRef: MutableRefObject<Texture | null>;
  previewElementRef: MutableRefObject<HTMLImageElement | HTMLMediaElement | null>;
  ...
  streamOwnedRef: MutableRefObject<boolean>;
  ...
  isLoopingRef: MutableRefObject<boolean>;
