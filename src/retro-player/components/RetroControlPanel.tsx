        ...
        <div className="mt-4 border-t border-[#cac0b2] pt-4">
          ...
          <React.Suspense fallback={controlsFallback}>
            <RetroFilterPanel
              ...
              wideGlowMode={filterState.wideGlowMode}
              ...
              onSetPreFilterDownscaleEnabled={filterState.setPreFilterDownscaleEnabled}
              ...
              onSetWideGlowMode={filterState.setWideGlowMode}
