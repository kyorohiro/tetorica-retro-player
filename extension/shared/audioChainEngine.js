...
export function updateAudioChainNodes(nodes, settings) {
    const { radioToneHighpassNode, radioToneLowpassNode, radioTonePresenceNode, lofiLowpassNode, lofiHighshelfNode, lofiDriveNode, bitcrusherNode, stereoWidthNode, postCrushLowpassNode, bassEqNode, midEqNode, trebleEqNode, tapeSaturatorNode, roomDryGainNode, roomWetGainNode, wowFlutterDelayNode, wowLfoNode, wowLfoGainNode, flutterLfoNode, flutterLfoGainNode, echoDelayLineNode, echoFeedbackGainNode, echoWetGainNode, hallReverbWetGainNode, chorusLfoGain1Node, chorusLfoGain2Node, chorusWetGainNode, busCompressorNode, fxOutputGainNode, noiseGainNode, crackleGainNode, vinylDustBedFilterNode, vinylDustBedGainNode, } = nodes;
    {
    ...
    try {
        tapeSaturatorNode.curve = createTapeSaturationCurve(settings.isAudioFxEnabled ? settings.tapeSaturationAmount : 0);
    }
    catch {
